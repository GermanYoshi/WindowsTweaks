...
echo ################################################################################
echo #                                                                              #
echo # FR33THY Disable Services Batch Script                                        #
echo #                                                                              #
...
echo # happen if the script tries to stop a service that isn't running or doesn't   #
echo # exist. Do not worry as this is normal.                                       #
echo #                                                                              #
